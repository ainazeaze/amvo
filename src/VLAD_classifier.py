...
from vlad import dataset_to_vlad, dataset_to_vlad_pca
...
def make_dataset(image_dir=IMAGE_DIR):
    ...
    """
    descriptors = dataset_to_vlad(image_dir)
...
def train_eval(test_size=0.2, random_state=42):
